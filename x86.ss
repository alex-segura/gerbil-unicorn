...
(def x86-mmr-selector uc_x86_mmr_selector)
(def x86-mmr-base uc_x86_mmr_base)
(def x86-mmr-limit uc_x86_mmr_limit)
(def x86-mmr-flags uc_x86_mmr_flags)
(def make-x86-mmr make_x86_mmr)

(def x86-msr-rid uc_x86_msr_rid)
(def x86-msr-value uc_x86_msr_value)
(def make-x86-msr make_x86_msr)
...
(begin-ffi
  ...
  (c-declare "#include <unicorn/x86.h>")

  (c-define-type x86_mmr "uc_x86_mmr")
  (c-define-type x86_mmr* (pointer x86_mmr (x86_mmr*) "ffi_free"))

  (define-c-lambda make_x86_mmr (unsigned-int16 unsigned-int64 unsigned-int32 unsigned-int32)
    x86_mmr*
#<<END-C
uc_x86_mmr* mmr = (uc_x86_mmr *) malloc (sizeof(uc_x86_mmr));
mmr->selector = ___arg1;
mmr->base = ___arg2;
mmr->limit = ___arg3;
mmr->flags = ___arg4;
return mmr;
END-C
  ...
  (define-c-lambda uc_x86_mmr_selector (x86_mmr*) unsigned-int16
    "___return (___arg1->selector);")
  (define-c-lambda uc_x86_mmr_base (x86_mmr*) unsigned-int64
    "___return (___arg1->base);")
  (define-c-lambda uc_x86_mmr_limit (x86_mmr*) unsigned-int32
    "___return (___arg1->limit);")
  (define-c-lambda uc_x86_mmr_flags (x86_mmr*) unsigned-int32
    "___return (___arg1->flags);")

  (c-define-type x86_msr "uc_x86_msr")
  (c-define-type x86_msr* (pointer x86_msr (x86_msr*) "ffi_free"))

  (define-c-lambda make_x86_msr (unsigned-int32 unsigned-int64) x86_msr*
#<<END-C
uc_x86_msr* msr = (uc_x86_msr*) malloc(sizeof(uc_x86_msr));
msr->rid = ___arg1;
msr->value = ___arg2;
return msr;
END-C
)
  (define-c-lambda uc_x86_msr_rid (x86_msr*) unsigned-int32
    "___return (___arg1->rid);")
  (define-c-lambda uc_x86_msr_value (x86_msr*) unsigned-int64
    "___return (___arg1->value);")

  (defenum (uc_x86_reg "uc_x86_reg")
    UC_X86_REG_INVALID
    UC_X86_REG_AH
    UC_X86_REG_AL
    UC_X86_REG_AX
  ...
  (defenum (uc_x86_insn "uc_x86_insn")
    UC_X86_INS_INVALID
    UC_X86_INS_AAA
    UC_X86_INS_AAD
    UC_X86_INS_AAM
